...
//   RAMLS4      		: origin = 0x00A000, length = 0x000800
   ...
   FLASH_BANK0_SEC1_15  : origin = 0x081000, length = 0x00F000	/* on-chip Flash */
   ...
   /* BANK 1 */
   FLASH_BANK1_SEC0_15  : origin = 0x090000, length = 0x00FFF0	/* on-chip Flash */
...
SECTIONS
{
   ...
   .text            : >> FLASH_BANK0_SEC1_15 ,   PAGE = 0, ALIGN(4)
   .cinit           : > FLASH_BANK1_SEC0_15,     PAGE = 0, ALIGN(4)
   .switch          : > FLASH_BANK1_SEC0_15,     PAGE = 0, ALIGN(4)
   .reset           : > RESET,     PAGE = 0, TYPE = DSECT /* not used, */

   .stack           : > RAMM1,     PAGE = 1

#if defined(__TI_EABI__)
   .init_array      : > FLASH_BANK1_SEC0_15,       PAGE = 0,       ALIGN(4)
   .bss             : > RAMLS0_4,     PAGE = 0
